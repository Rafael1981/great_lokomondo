...
class LivrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create livro" do
    assert_difference("Livro.count") do
      post livros_url, params: { livro: { categoria: @livro.categoria, data_alte: @livro.data_alte, data_cad: @livro.data_cad, titulo: @livro.titulo } }
    end
  ...
  test "should update livro" do
    patch livro_url(@livro), params: { livro: { categoria: @livro.categoria, data_alte: @livro.data_alte, data_cad: @livro.data_cad, titulo: @livro.titulo } }
