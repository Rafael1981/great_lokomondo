...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference("Reserva.count") do
      post reservas_url, params: { reserva: { data_devolucao: @reserva.data_devolucao, data_reserva: @reserva.data_reserva, status_reserva: @reserva.status_reserva } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { data_devolucao: @reserva.data_devolucao, data_reserva: @reserva.data_reserva, status_reserva: @reserva.status_reserva } }
